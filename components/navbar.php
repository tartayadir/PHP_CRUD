        ...
        <?php if ($showSearch): ?>
            <ul class="navbar-nav mr-auto">
                <?php foreach ($tables as $table): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="?table=<?= $table ?>"><?= normalizeTestView($table) ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>

            <div class="my-2 my-lg-0 mr-sm-2">
                <a href="./crud/add_record.php?table=<?= $selectedTable ?>" class="btn btn-outline-info my-2 my-sm-0">Add New Record</a>
